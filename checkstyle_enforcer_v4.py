...
# folder_path = input("Please specify the folder path to enforce in: ")
# while not os.path.isdir(folder_path):
#     print("Specified folder path:", folder_path, "does not exist.")
#     folder_path = input("Please specify the folder path to enforce in: ")
folder_path = "BadJavaStyleExamples"

# Search for all files with a .java extension in the current directory
java_files = glob.glob(folder_path + "/*.java")
